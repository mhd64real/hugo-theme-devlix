...
A small Hugo theme for a personal site with a blog. Plain HTML, one CSS file, one tiny JS file, CSS-only dark mode. The site works fully without JavaScript.
